...
through a zero-knowledge proof, so a payout cannot be traced back to the bet that earned it. A
relayer submits your bets and withdrawals for you too, so even the transaction itself doesn't
carry your wallet address.
