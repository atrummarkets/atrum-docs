...
<Warning>
**Not ready for real money.** The trusted setup has a single contribution, and decryption
currently uses a single committee key held by the operator. Both are documented in
[Limits](/reference/limits) and both must be resolved before mainnet.
</Warning>
