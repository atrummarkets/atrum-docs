...
link from your address to your position is cut — and a relayer, not your wallet, typically
submits the transaction, so your address doesn't even appear as its sender.
...
position to your money is cut. Relayed as well.

**Withdraw.** Turn a settled note into collateral in your wallet, at a time you choose, in a
standard amount. Public — but unconnected to anything above. The transaction is relayed too:
public because collateral has to land somewhere, not because you signed it.
